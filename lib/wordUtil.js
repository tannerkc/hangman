export const categories = {
    ...
    "Sports": [
        ...
        "jujitsu", "kickboxing", "land sailing", "muay thai", "paintball", "quidditch", "road racing", "softball", "trampolining"
    ],
    "Colors": [
    ...
    "Cities": [
        ...
        "bangkok", "barcelona", "beijing", "buenosaires", "cape town", "chicago", "delhi", "hong kong", "istanbul", "jakarta", "kuala lumpur", "lisbon", "los angeles", "madrid", "mexico city", "milan", "miami", "montreal", "mumbai", "munich", "nairobi", "osaka", "philadelphia", "prague", "rio de janeiro", "san francisco", "santiago", "seoul", "shanghai", "singapore", "stockholm", "toronto", "vienna", "warsaw", "zurich", "abu dhabi", "athens", "auckland", "baghdad", "belgrade", "brussels", "cairo", "colombo", "copenhagen", "dublin", "edmonton", "gothenburg", "kiev", "kingston", "lausanne", "luxembourg", "manila", "naples", "oslo", "porto", "quito", "reykjavik", "riyadh", "rotterdam", "sofia", "st. petersburg", "tallinn", "tel aviv", "thessaloniki", "vancouver", "venice", "wellington", "amritsar", "antwerp", "baku", "brasilia", "brisbane", "bucharest", "casablanca", "charlotte", "dakar", "dhaka"
    ],
    "Brands": [
        "nike", "adidas", "apple", "samsung", "sony", "tesla", "microsoft", "google", "amazon", "facebook", "bmw", "coca cola", "disney", "ford", "general electric", "honda", "ibm", "intel", "johnson & johnson", "kfc", "lg", "louis vuitton", "mastercard", "mcdonalds", "mercedes-benz", "nestle", "nissan", "pepsi", "philips", "porsche", "red bull", "santander", "shell", "starbucks", "toyota", "visa", "volkswagen", "walmart", "whirlpool", "xbox", "yahoo", "zara", "acer", "airbnb", "audi", "avon", "baidu", "boeing", "burberry", "cadillac", "canon", "chanel", "chevrolet", "dell", "dior", "domino's", "durex", "ebay", "exxon", "fedex", "ferrari", "fujitsu", "gopro", "gucci", "harley davidson", "heineken", "hermes", "hp", "hyundai", "ikea", "jaguar", "jbl", "john deere", "kellogg's", "kodak", "lego", "levi's", "lexus", "lucasfilm", "marlboro", "michelin", "moet", "nivea", "oracle", "pampers", "paypal", "prada", "reebok", "rolex"
    ]
};
...
//         moderate: ['elephant', 'giraffe', 'penguin', 'turtle'],
//         hard: ['chimpanzee', 'kangaroo', 'crocodile', 'panther']
//     },
//     cities: {
//         easy: ['rome', 'paris', 'tokyo', 'cairo'],
//         moderate: ['sydney', 'berlin', 'moscow', 'lisbon'],
//         hard: ['quito', 'reykjavik', 'kathmandu', 'buenos aires']
//     }
// };